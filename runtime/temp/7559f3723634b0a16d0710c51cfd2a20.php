<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpStudy\WWW\TMS\TP5\public/../application/admin\view\index\index.html";i:1507200663;s:75:"D:\phpStudy\WWW\TMS\TP5\public/../application/admin\view\common\header.html";i:1507363041;s:71:"D:\phpStudy\WWW\TMS\TP5\public/../application/admin\view\common\js.html";i:1507120356;}*/ ?>
  <!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                ...
                <div class="layui-main">
                    ...
                    <ul class="layui-nav" lay-filter="">
                      ...
                      <li class="layui-nav-item">
                        <a href="javascript:;"><?php echo session('user_info.name'); ?></a> <!-- 获取Session中的信息 -->
                        <dl class="layui-nav-child"> <!-- 二级菜单 -->
                          <dd><a href="">个人信息</a></dd>
                          <dd><a href="">切换帐号</a></dd>
                          <dd><a href="<?php echo url('admin/logout'); ?>">注销</a></dd>
                        </dl>
                      </li>
                      <!-- <li class="layui-nav-item">
                        <a href="" title="消息">
                    ...
                    <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="<?php echo url('info/questionList'); ?>">
                                            <cite>问题列表</cite>
                                        </a>
                                    </dd>
                                </dd>
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="<?php echo url('info/questionDel'); ?>">
                                            <cite>删除问题</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="<?php echo url('info/bannerList'); ?>">
                                            <cite>轮播列表</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="<?php echo url('admin/adminList'); ?>">
                                        <cite>管理员列表</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="<?php echo url('admin/adminRole'); ?>">
                                        <cite>角色管理</cite>
                                    </a>
                                </dd>
                            </dl>
